...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    this.loadPosts();
    const server = openSocket("http://localhost:5050");
    server.on("posts", (data) => {
  ...
  finishEditHandler = (postData) => {
    ...
    if (this.state.editPost) {
      url = "http://localhost:5050/feed/post/" + this.state.editPost._id;
      method = "PUT";
    }
  ...
  deletePostHandler = (postId) => {
    ...
    fetch("http://localhost:5050/feed/post/" + postId, {
      method: "DELETE",
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
